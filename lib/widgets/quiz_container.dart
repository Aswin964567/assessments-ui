import 'package:assessments/data/questions.dart';
import 'package:assessments/widgets/box_row.dart';
import 'package:assessments/widgets/button.dart';
import 'package:assessments/widgets/dialog_box.dart';
import 'package:assessments/widgets/options.dart';
import 'package:assessments/widgets/select_option.dart';
...
class _QuizContainerState extends State<QuizContainer> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
         BoxRow(number: currentQuestionIndex < 3 ? questionNumber: 25,),
        const SizedBox(
          height: 10,
        ),
        Container(
